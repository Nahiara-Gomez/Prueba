...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2025 a las 02:44:58
...
INSERT INTO `inasistencias` (`IDfaltax`, `Nombrex`, `Apellidox`, `CIx`, `Turnox`, `FechaInix`, `FechaFinx`, `Motivox`) VALUES
(1, 'ww', 'ww', '123', 'de', '2025-11-10', '2025-11-11', 'de'),
(3, 'nk', 'ko', '88', 'jjn', '2025-11-08', '2025-11-09', 'de');
...
--
ALTER TABLE `inasistencias`
  MODIFY `IDfaltax` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
